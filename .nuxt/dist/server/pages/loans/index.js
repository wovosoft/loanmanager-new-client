exports.ids = [24,3,4,6,8,12,14,19];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/LoansAdd.vue?vue&type=template&id=07e7bd1c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('b-modal',{attrs:{"header-class":"py-2","footer-class":"py-1","button-size":"sm","title":_vm.$t('loan_details'),"header-bg-variant":"dark","ok-title":_vm.$t('submit'),"cancel-title":_vm.$t('cancel'),"header-text-variant":"light"},on:{"shown":function($event){return _vm.getAccounts(_vm.item.borrower_id);},"hidden":function($event){_vm.$emit('input',false);_vm.$emit('hidden',true);_vm.resetItem();},"ok":function($event){$event.preventDefault();return _vm.handleSubmit.apply(null, arguments)}},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var hide = ref.hide;
return [_c('b-form',{ref:"the_form",on:{"submit":function($event){$event.preventDefault();return _vm.handleSubmit(hide)}}},[_c('table',{staticClass:"table table-sm table-bordered table-hover"},[_c('tr',[_c('th',[_vm._v(_vm._s(_vm.$t('borrower'))+" *")]),_vm._v(" "),_c('td',{staticClass:"p-0"},[_c('borrowers-select',{staticClass:"border-0",attrs:{"required":""},on:{"itemSelected":function (v){
                                _vm.getAccounts(v.value);
                                _vm.item.account_id=null;
                            }},model:{value:(_vm.item.borrower_id),callback:function ($$v) {_vm.$set(_vm.item, "borrower_id", $$v)},expression:"item.borrower_id"}})],1)]),_vm._v(" "),_c('tr',[_c('th',[_vm._v(_vm._s(_vm.$t('account'))+" *")]),_vm._v(" "),_c('td',{staticClass:"p-0"},[_c('b-form-select',{staticClass:"border-0",attrs:{"size":"sm","required":"","options":_vm.accounts},model:{value:(_vm.item.account_id),callback:function ($$v) {_vm.$set(_vm.item, "account_id", $$v)},expression:"item.account_id"}})],1)]),_vm._v(" "),_vm._l((['disbursement_date','closing_date','loan_amount',
                    'installment_amount','installment_quantity','status']),function(x){return _c('tr',[_c('th',[_vm._v(_vm._s(_vm.$t(x) + (_vm.isRequired(x) ? ' *' : '')))]),_vm._v(" "),_c('td',{staticClass:"p-0"},[(['status'].includes(x))?[_c('b-form-select',{staticClass:"border-0",attrs:{"size":"sm","options":_vm.loan_statuses},model:{value:(_vm.item[x]),callback:function ($$v) {_vm.$set(_vm.item, x, $$v)},expression:"item[x]"}})]:[_c('b-form-input',_vm._b({staticClass:"border-0",attrs:{"size":"sm","required":_vm.isRequired(x)},model:{value:(_vm.item[x]),callback:function ($$v) {_vm.$set(_vm.item, x, $$v)},expression:"item[x]"}},'b-form-input',_vm.getType(x),false))]],2)])})],2)])]}}]),model:{value:(_vm.is_visible),callback:function ($$v) {_vm.is_visible=$$v},expression:"is_visible"}})}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/LoansAdd.vue?vue&type=template&id=07e7bd1c&

// CONCATENATED MODULE: ./partials/loan_statuses.js
/* harmony default export */ var loan_statuses = (context => {
  return [{
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/LoansAdd.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var LoansAddvue_type_script_lang_js_ = ({
  props: {
    item: {
      type: Object | null
    },
  ...
  methods: {
    ...
    handleSubmit(hide) {
      Object(form_methods["a" /* handleSubmit */])(this, hide, "/loans/store", JSON.parse(JSON.stringify(this.item)));
    },
...
// CONCATENATED MODULE: ./components/LoansAdd.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_LoansAddvue_type_script_lang_js_ = (LoansAddvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/LoansAdd.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  components_LoansAddvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var LoansAdd = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/loans/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var loansvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      fields: [{
        ...
        sortable: true,
        label: this.$t("last_collection_date"),
  ...
  methods: {
    setItem() {
      this.$set(this, 'item', {
        borrower_id: null,
        account_id: null,
        disbursement_date: Object(helpers["a" /* getTodayYMD */])(),
        closing_date: null,
        loan_amount: 0,
...
// CONCATENATED MODULE: ./pages/loans/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_loansvue_type_script_lang_js_ = (loansvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/loans/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_loansvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var loans = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {ApiSelectable: __webpack_require__(62).default,ActionBtns: __webpack_require__(53).default,DatatableFooter: __webpack_require__(55).default,LoansView: __webpack_require__(75).default,LoansAdd: __webpack_require__(70).default})
